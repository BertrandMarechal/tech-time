  ...
  return (
    <nav className="sticky top-0 z-50 left-0 right-0 flex justify-between items-center p-2 bg-amber-700 h-14">
      ...
      <ul className="flex flex-row gap-2">
        <li>
          <Button className={`${selectedBackend === BackendType.Python ? "border-amber-400" : "border-transparent"} bg-transparent hover:bg-transparent hover:border-amber-300 border-2`} onClick={() => handleClickOnBackendOrigin(BackendType.Python)}>
        ...
        <li>
          <Button className={`${selectedBackend === BackendType.Go ? "border-amber-400" : "border-transparent"} bg-transparent hover:bg-transparent hover:border-amber-300 border-2`} onClick={() => handleClickOnBackendOrigin(BackendType.Go)}>
            <div className="flex flex-row gap-2 items-center">
